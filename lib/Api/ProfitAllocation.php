...
use Entpay\Mse\Client\Model\AllocationAccountLink;
use Entpay\Mse\Client\Model\ModelInterface;
use Entpay\Mse\Client\Model\ProfitAllocationReceiver;
use Entpay\Mse\Client\Model\ProfitAllocationReceiverAccount;
use Entpay\Mse\Client\Model\SupportedAllocationPaymentList;
use Entpay\Mse\Client\ObjectSerializer;
use JsonSerializable;

/**
 * ProfitAllocation Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 */
class ProfitAllocation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocation';
     ...
     *
     * @param \Entpay\Mse\Client\Model\ProfitAllocationParam $profit_allocation_param (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions       $request_options         (optional)
     *
     * @throws \InvalidArgumentException
     * @return ProfitAllocation
     */
    public static function create($profit_allocation_param, $request_options = null)
    {
        $path = '/v3/mse-pay/profit-allocations';

        return EntpayClient::getDefaultClient()->doRequest(
            'POST',
            $path,
            $profit_allocation_param,
    ...
    /**
     * Create request for operation 'createAccountApplicationLink'.
     *
     * @param string                                   $application_id  (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions $request_options (optional)
     *
     * @throws \InvalidArgumentException
     * @return AllocationAccountLink
     */
    public static function createAccountApplicationLink($application_id, $request_options = null)
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/receiver-accounts-simple-applications/%s/links', urlencode($application_id));

        return EntpayClient::getDefaultClient()->doRequest(
            'POST',
            $path,
            null,
            AllocationAccountLink::class,
            $request_options
        );
    }

    /**
     * Create request for operation 'createAccountSimpleApplication'.
     *
     * @param \Entpay\Mse\Client\Model\ProfitAllocationReceiverApplicationParam $profit_allocation_receiver_application_param (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions                          $request_options                              (optional)
     *
     * @throws \InvalidArgumentException
     * @return ProfitAllocationReceiver
     */
    public static function createAccountSimpleApplication($profit_allocation_receiver_application_param, $request_options = null)
    {
        $path = '/v3/mse-pay/profit-allocations/receiver-accounts-simple-applications';

        return EntpayClient::getDefaultClient()->doRequest(
            'POST',
            $path,
            $profit_allocation_receiver_application_param,
            ProfitAllocationReceiver::class,
            $request_options
        );
    }
     ...
     *
     * @param \Entpay\Mse\Client\Model\ProfitAllocationFinishParam $profit_allocation_finish_param (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions             $request_options                (optional)
     *
     * @throws \InvalidArgumentException
     * @return ProfitAllocation
     */
    public static function finish($profit_allocation_finish_param, $request_options = null)
    {
        $path = '/v3/mse-pay/profit-allocations/finish';

        return EntpayClient::getDefaultClient()->doRequest(
            'POST',
            $path,
            $profit_allocation_finish_param,
            ProfitAllocation::class,
            $request_options
        );
    }
    ...
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/%s', urlencode($allocation_id));
     ...
     *
     * @param \Entpay\Mse\Client\Model\RetrieveAccountGetParam $param           (optional)
     * @param \Entpay\Mse\Client\Config\RequestOptions         $request_options (optional)
     *
     * @throws \InvalidArgumentException
     * @return ProfitAllocationReceiverAccount
     */
    public static function retrieveAccount($param = null, $request_options = null)
    {
        $path = '/v3/mse-pay/profit-allocations/receiver-accounts';
        if (null != $param) {
        ...
        return EntpayClient::getDefaultClient()->doRequest(
            ...
            $path,
            null,
            ProfitAllocationReceiverAccount::class,
            $request_options
        );
    }

    /**
     * Create request for operation 'retrieveAccountApplication'.
     *
     * @param string                                   $application_id  (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions $request_options (optional)
     *
     ...
     * @return ProfitAllocationReceiver
     */
    public static function retrieveAccountApplication($application_id, $request_options = null)
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/receiver-accounts-applications/%s', urlencode($application_id));
    ...
    /**
     * Create request for operation 'retrieveAccountApplicationByOutApplicationId'.
     *
     * @param string                                   $out_application_id (required)
     * @param \Entpay\Mse\Client\Config\RequestOptions $request_options    (optional)
     *
     * @throws \InvalidArgumentException
     * @return ProfitAllocationReceiver
     */
    public static function retrieveAccountApplicationByOutApplicationId($out_application_id, $request_options = null)
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/receiver-accounts-applications/out-application-id/%s', urlencode($out_application_id));
     ...
     * @return ProfitAllocation
     */
    public static function retrieveBalance($payment_id, $request_options = null)
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/%s/amounts', urlencode($payment_id));
    ...
    {
        $path = sprintf('/v3/mse-pay/profit-allocations/out-allocation-id/%s', urlencode($out_allocation_id));
    ...
    /**
     * Create request for operation 'retrieveSupportedAllocationPaymentList'.
     *
     * @param \Entpay\Mse\Client\Model\RetrieveSupportedAllocationPaymentListGetParam $param           (optional)
     * @param \Entpay\Mse\Client\Config\RequestOptions                                $request_options (optional)
     *
     * @throws \InvalidArgumentException
     * @return SupportedAllocationPaymentList
     */
    public static function retrieveSupportedAllocationPaymentList($param = null, $request_options = null)
    {
        $path = '/v3/mse-pay/profit-allocations/payment-list/supported-allocation';
        if (null != $param) {
            $path = $path . '?' . http_build_query($param->container);
        }
        ...
        return EntpayClient::getDefaultClient()->doRequest(
            ...
            $path,
            null,
            SupportedAllocationPaymentList::class,
            $request_options
        );
    }
}
