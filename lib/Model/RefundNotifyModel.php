...
/**
 * RefundNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 退款回调对象
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class RefundNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RefundNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\Refund',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\Refund|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\Refund|null $event_content event_content
     *
     * @return self
     */
