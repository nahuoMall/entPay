...
/**
 * PaymentQRParam Class Doc Comment.
 *
 * @category Class
 * @description 二维码支付下单请求参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PaymentQRParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentQRParam';
