...
/**
 * ProfitAllocationParam Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ProfitAllocationParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocationParam';
     ...
     * Sets allocations.
     *
     * @param \Entpay\Mse\Client\Model\AllocationParam[] $allocations allocations
     *
     * @return self
     */
