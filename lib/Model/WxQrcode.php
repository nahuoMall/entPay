...
/**
 * WxQrcode Class Doc Comment.
 *
 * @category Class
 * @description 【后续废弃】小程序二维码参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class WxQrcode implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WxQrcode';
