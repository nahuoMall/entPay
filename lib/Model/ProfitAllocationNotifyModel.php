...
/**
 * ProfitAllocationNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 分账回调对象
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class ProfitAllocationNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocationNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\ProfitAllocation',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\ProfitAllocation|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\ProfitAllocation|null $event_content event_content
     *
     * @return self
     */
