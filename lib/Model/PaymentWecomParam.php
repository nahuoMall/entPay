...
/**
 * PaymentWecomParam Class Doc Comment.
 *
 * @category Class
 * @description 支付下单请求参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PaymentWecomParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentWecomParam';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['purchaser_type']) && (mb_strlen($this->container['purchaser_type']) > 32)) {
            $invalidProperties[] = "invalid value for 'purchaser_type', the character length must be smaller than or equal to 32.";
        }

        if (!is_null($this->container['purchaser_type']) && (mb_strlen($this->container['purchaser_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'purchaser_type', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets purchaser_type.
     *
     * @param string|null $purchaser_type 付款类型
     *
     * @return self
     */
