...
/**
 * PaymentH5Param Class Doc Comment.
 *
 * @category Class
 * @description H5支付下单请求参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PaymentH5Param implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentH5Param';
