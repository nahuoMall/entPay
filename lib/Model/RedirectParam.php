...
/**
 * RedirectParam Class Doc Comment.
 *
 * @category Class
 * @description 跳转请求参数
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class RedirectParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RedirectParam';
     ...
     * Sets payment_id.
     *
     * @param string|null $payment_id 微企付支付单号
     *
     * @return self
     */
