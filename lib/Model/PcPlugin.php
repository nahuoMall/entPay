...
/**
 * PcPlugin Class Doc Comment.
 *
 * @category Class
 * @description 【后续废弃】Web组件参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PcPlugin implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PcPlugin';
