...
/**
 * ApplicationAllocationReceiver Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ApplicationAllocationReceiver implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ApplicationAllocationReceiver';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['receiver_acct_id']) && (mb_strlen($this->container['receiver_acct_id']) > 64)) {
            $invalidProperties[] = "invalid value for 'receiver_acct_id', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['receiver_acct_id']) && (mb_strlen($this->container['receiver_acct_id']) < 1)) {
        ...
        if (null === $this->container['out_receiver_name']) {
            $invalidProperties[] = "'out_receiver_name' can't be null";
        }
        if ((mb_strlen($this->container['out_receiver_name']) > 64)) {
            $invalidProperties[] = "invalid value for 'out_receiver_name', the character length must be smaller than or equal to 64.";
        }

        if ((mb_strlen($this->container['out_receiver_name']) < 1)) {
     ...
     *
     * @param string|null $receiver_acct_id receiver_acct_id
     *
     * @return self
     */
     ...
     *
     * @param string $out_receiver_name out_receiver_name
     *
     * @return self
     */
