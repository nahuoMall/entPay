<?php
/**
 * MseFundsApplicationNotifyModel.
 *
 * @category Class
...
/**
 * MseFundsApplicationNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 微资金账户开通回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class MseFundsApplicationNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MseFundsApplicationNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\MseFundsAccountApplication',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\MseFundsAccountApplication|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\MseFundsAccountApplication|null $event_content event_content
     *
     * @return self
     */
