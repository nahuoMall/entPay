...
/**
 * ProductApplicationNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 产品开通回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ProductApplicationNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductApplicationNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\ProductApplication',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\ProductApplication|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\ProductApplication|null $event_content event_content
     *
     * @return self
     */
