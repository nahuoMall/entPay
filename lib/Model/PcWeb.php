 ...
 */
class PcWeb implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PcWeb';
     ...
     * Sets expire_time.
     *
     * @param \DateTime $expire_time 跳转凭证过期时间
     *
     * @return self
     */
