...
/**
 * PaymentNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 支付回调对象
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class PaymentNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\Payment',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\Payment|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\Payment|null $event_content event_content
     *
     * @return self
     */
