...
/**
 * WithdrawFailReason Class Doc Comment.
 *
 * @category Class
 * @description 失败原因
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class WithdrawFailReason implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WithdrawFailReason';
    ...
    protected static $openAPITypes = [
        'failed_type'   => '\Entpay\Mse\Client\Model\WithdrawFailTypeEnum',
     ...
     * Gets failed_type.
     *
     * @return \Entpay\Mse\Client\Model\WithdrawFailTypeEnum|null
     */
     ...
     * Sets failed_type.
     *
     * @param \Entpay\Mse\Client\Model\WithdrawFailTypeEnum|null $failed_type failed_type
     *
     * @return self
     */
     ...
     * Sets failed_detail.
     *
     * @param string|null $failed_detail 失败原因详情
     *
     * @return self
     */
