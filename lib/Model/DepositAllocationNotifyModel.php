...
/**
 * DepositAllocationNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 收银分账回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class DepositAllocationNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DepositAllocationNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\DepositAllocation',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\DepositAllocation|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\DepositAllocation|null $event_content event_content
     *
     * @return self
     */
