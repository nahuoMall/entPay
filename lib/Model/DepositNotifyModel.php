...
/**
 * DepositNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 收银回调对象
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class DepositNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DepositNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\Deposit',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\Deposit|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\Deposit|null $event_content event_content
     *
     * @return self
     */
