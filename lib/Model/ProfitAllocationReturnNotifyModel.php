<?php
/**
 * ProfitAllocationReturnNotifyModel.
 *
 * @category Class
...
/**
 * ProfitAllocationReturnNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 分账回退回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ProfitAllocationReturnNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocationReturnNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\ProfitAllocationReturn',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\ProfitAllocationReturn|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\ProfitAllocationReturn|null $event_content event_content
     *
     * @return self
     */
