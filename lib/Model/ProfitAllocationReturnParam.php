...
/**
 * ProfitAllocationReturnParam Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ProfitAllocationReturnParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocationReturnParam';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['out_allocation_detail_return_id']) {
            $invalidProperties[] = "'out_allocation_detail_return_id' can't be null";
        }
        if ((mb_strlen($this->container['out_allocation_detail_return_id']) > 64)) {
            $invalidProperties[] = "invalid value for 'out_allocation_detail_return_id', the character length must be smaller than or equal to 64.";
        }

        if ((mb_strlen($this->container['out_allocation_detail_return_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'out_allocation_detail_return_id', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $out_allocation_detail_return_id out_allocation_detail_return_id
     *
     * @return self
     */
