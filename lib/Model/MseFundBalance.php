...
/**
 * MseFundBalance Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class MseFundBalance implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MseFundBalance';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['available_amount']) {
     ...
     *
     * @param int $available_amount 账户可用余额
     *
     * @return self
     */
