<?php
/**
 * AllocationReceiverBusinessLicense.
 *
 * @category Class
...
/**
 * AllocationReceiverBusinessLicense Class Doc Comment.
 *
 * @category Class
 * @description 分账接收方营业执照信息
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class AllocationReceiverBusinessLicense implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AllocationReceiverBusinessLicense';
    ...
    protected static $setters = [
        ...
        'registered_capital'         => 'setRegisteredCapital',
    ...
    protected static $getters = [
        ...
        'registered_capital'         => 'getRegisteredCapital',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['registered_capital']         = isset($data['registered_capital']) ? $data['registered_capital'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['registered_capital']) && ($this->container['registered_capital'] < 0)) {
            $invalidProperties[] = "invalid value for 'registered_capital', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['merchant_address']) && (mb_strlen($this->container['merchant_address']) > 128)) {
            $invalidProperties[] = "invalid value for 'merchant_address', the character length must be smaller than or equal to 128.";
        }

        if (!is_null($this->container['merchant_address']) && (mb_strlen($this->container['merchant_address']) < 1)) {
            $invalidProperties[] = "invalid value for 'merchant_address', the character length must be bigger than or equal to 1.";
        }
    ...
    /**
     * Gets registered_capital.
     *
     * @return int|null
     */
    public function getRegisteredCapital()
    {
        return $this->container['registered_capital'];
    }

    /**
     * Sets registered_capital.
     *
     * @param int|null $registered_capital 注册资本
     *
     * @return self
     */
    public function setRegisteredCapital($registered_capital)
    {
        $this->container['registered_capital'] = $registered_capital;
     ...
     *
     * @param string|null $merchant_address 商户地址
     *
     * @return self
     */
